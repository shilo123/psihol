...
1. **הגב תמיד בעברית** — כל התשובות, ההסברים, והחישובים חייבים להיות בעברית.
2. **הכר את הלוגיקה הקיימת לפני שינוי** — לפני כל שינוי בקוד, קרא והבן את כל הלוגיקה הקיימת בקבצים הרלוונטיים. אל תשנה קוד בלי להכיר את ההקשר המלא.
